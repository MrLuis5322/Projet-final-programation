...
class Accueil(tk.Frame):  # Définition de la classe Accueil comme un frame tkinter
    ...
    def __init__(self, master, res_width, res_height): # Appel du constructeur
        ...
        self.ax.legend(loc="upper left", prop = { "size": 20*res_width }, markerscale=0.6*res_width, bbox_to_anchor=(1, 1)) # Place la legend et definit sa taille selon la resolution de lutilisateur
    ...
    def plot_obstacles_and_goal(self):  # Méthode pour tracer les obstacles et la cible
        ...
        # Tracé de la cible
        self.ax.plot(self.joueur.cible_position[0], self.joueur.cible_position[1], 'ro', markersize=20*self.res_width, label='Cible') # DE TOUCHER AVANT DE TOUCHER
