...
class Formulaire(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        self.gender_var = tk.StringVar(value="Non specifie")
        self.gender_male_rb = ctk.CTkRadioButton(self, text="Homme", variable=self.gender_var, value="Homme")
        self.gender_male_rb.grid(row=2, column=1, padx=20, pady=(10, 10), sticky="w")
        self.gender_female_rb = ctk.CTkRadioButton(self, text="Femme", variable=self.gender_var, value="Femme")
        self.gender_female_rb.grid(row=3, column=1, padx=20, pady=(10, 10), sticky="w")

        # Langues parl�es
        self.languages_label = ctk.CTkLabel(self, text="Langues parlees:")
        self.languages_label.grid(row=4, column=0, padx=20, pady=(10, 10), sticky="w")
        self.languages = ["Francais", "Anglais", "Espagnol"]
        self.language_vars = {lang: tk.BooleanVar() for lang in self.languages}

        # Creating checkboxes for languages
        i = 5
